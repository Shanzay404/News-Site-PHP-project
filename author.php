            ...
            <div class="col-md-8">
                ...
                <h2 class="page-heading">Author: <?php echo $row1['username']; ?></h2>
                    ...
                    $offset = ($page_no - 1) * $limit;
                        ...
                        $sql = "SELECT * FROM `post` LEFT JOIN `category` ON `post`.`category` = `category`.`category_id` LEFT JOIN `user` ON `post`.`author` = `user`.`user_id` WHERE `post`.`author` = {$auth_id} ORDER BY `post`.`post_id` DESC limit $offset, $limit";
                    ...
                    if($page_no > 1){
                        echo "<li><a href='category.php?auth_id=".$auth_id."&page=".($page_no-1)."'>Prev</a></li>";
                    }
                    ...
                    if(mysqli_num_rows($result)>0){
                        ...
                        for($i=1; $i <= $total_pages; $i++) {
                            ...
                            echo "<li class='$active'><a href='category.php?auth_id=".$auth_id."&page=".$i."'>".$i."</a></li>";
                        }

                        if($page_no < $total_pages){
                        echo "<li><a href='category.php?auth_id=".$auth_id."&page=".($page_no+1)."'>Next</a></li>";
                        }
